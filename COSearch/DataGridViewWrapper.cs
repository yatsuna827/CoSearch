...
namespace COSearch
{
    class DataGridViewWrapper<TData>
    {
        ...
        // DefaultCellStyle.Font を Consolasにする
        // Alternative.BackColor を 255,255,192にする
        // その他いろいろFalseにする
        public DataGridViewWrapper(DataGridView dataGridView)
        {
            ...
            dataGridView.Columns.AddRange(headers.ToArray());
    ...
    class DataGridViewRowHeaderAttribute : Attribute
    {
        ...
        public DataGridViewRowHeaderAttribute(int width, string headerText, bool resizable = false, string font = null)
            => (this.Width, this.HeaderText, this.Resizable, this.Font) = (width, headerText, resizable, font);
    }
